...
public class DetalleCompra {
    ...
    public DetalleCompra(int codigoDetalleCompra, String observaciones, Date fechaServicio, double precioUnitario, int cantidad, int codigoCompra, int codigoProveedor) {
